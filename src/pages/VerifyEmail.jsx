...
function VerifyEmail() {
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)]  place-items-center grid">
      {loading ? (
        <div className="">
        ...
        <div className="max-w-[500px]  p-4 lg:p-8 ">
          ...
          <form onSubmit={handleVerifyAndSignup}>
            ...
            <button
              type="submit"
              className="w-full bg-yellow-50 py-[12px] px-[12px]
              rounded-[8px] mt-6 font-medium text-richblack-900"
            >
              Verify Email
            </button>
          </form>
